/*
 * $Id: calendar-setup-it.js 247 2008-07-20 08:59:10Z nicb $
 * Italian adaptation by Nicola Bernardini (2008)
 */
...
DateDueKeyboardShortcutSupport.prototype = {
  initialize: function(element, dateFormat) {
    ...
    title = this.element.getAttributeNode("title");
		tooltip = 'Scorciatoie: (o) oggi; (-) or (<) giorno prec.; (+) or (>) giorno seg.; ([) settimana prec.; (]) settimana seg.; ({) mese prec.; (}) mese seg.; Click per mostrare il calendario';
